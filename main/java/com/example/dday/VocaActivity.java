...
public class VocaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Voca_backbtn = (Button)findViewById(R.id.word_backbtn);


        Voca_backbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(VocaActivity.this,MainActivity.class);
